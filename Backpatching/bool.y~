...
%token <str> KEY AND OR NOT RELOP ID VAL SC CM PL MI MUL DIV POW OP CL AO AC EQ BO BC UNR TRUE FALSE IF ELSE 
%type <node> bool bb m n e t f g l r a if ifelse stmt stmt_list block decl
